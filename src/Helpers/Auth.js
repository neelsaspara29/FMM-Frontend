...
class Auth {
     ...
     */
    static getToken() {
        return JSON.parse(JSON.parse(localStorage.getItem(STORAGEKEY.token)).token);
    }
    /**
     * Get a token value.
     *
     ...
     */
    static getUserToken() {
        return JSON.parse(JSON.parse(localStorage.getItem(STORAGEKEY.usertoken)).usertoken);
    }
